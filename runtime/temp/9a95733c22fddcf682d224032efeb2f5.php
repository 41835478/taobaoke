<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\wamp\www\taobaoke\public/../application/home\view\search\index.html";i:1499858200;s:62:"D:\wamp\www\taobaoke\public/../application/home\view\base.html";i:1499874506;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<title><?php if(!(empty($keyword_title) || (($keyword_title instanceof \think\Collection || $keyword_title instanceof \think\Paginator ) && $keyword_title->isEmpty()))): ?><?php echo $keyword_title; endif; ?>-<?php echo \think\Config::get('system.website_title'); ?></title>
...
<div class="choose-container">
    <div class="choose-list product-category">
        ...
        <div class="list">
            <a class="<?php if(isset($urlInfo['cid'])): if($urlInfo['cid'] == 'all'): ?>active<?php endif; endif; ?>" href="<?php echo url('search/index',['keyword'=>$urlInfo['keyword']]); ?>">全部优惠<span>（<?php echo $baseData['cate']['totalNum']; ?>）</span></a>
            <?php if(!empty($baseData['cate']['cateInfo'])): foreach($baseData['cate']['cateInfo'] as $cate): ?>
            <a class="<?php if(isset($urlInfo['cid']) && ($urlInfo['cid'] === $cate['id'])): ?>active<?php endif; ?>" href="<?php echo url('search/index',['cid'=>$cate['id'],'keyword'=>$urlInfo['keyword']]); ?>"><?php echo $cate['cate_name']; ?><span>（<?php echo $cate['total']; ?>）</span></a>
            <?php endforeach; else: endif; ?>
