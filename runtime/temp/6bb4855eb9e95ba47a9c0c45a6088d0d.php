<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wamp\www\taobaoke\public/../application/admin\view\quan\index.html";i:1498667966;s:63:"D:\wamp\www\taobaoke\public/../application/admin\view\base.html";i:1497357983;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<script type="text/javascript">
    var add_url ='<?php echo url("quan/add"); ?>';
</script>
...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20 mt-top">
        ...
        <span class="r" style="line-height: 38px;">共有数据：<strong><?php echo $pageInfo['total']; ?></strong> 条</span>
    </div>
    <div class="mt-20">
        ...
        <table class="layui-table layui-form">
            ...
            <tbody>
            <?php if(!empty($collectList)): foreach($collectList as $vo): ?>
            <tr>
                ...
                <td><?php echo $vo['total_page']; ?></td>
                <td><?php echo $vo['cate_name']; ?></td>
                <td class="td-manage"  data-id="<?php echo $vo['id']; ?>" data-type="1">
                    <a style="text-decoration:none" class="ml-5 product-collect" href="javascript:void(0);" onclick="collect_product(1,<?php echo $vo['id']; ?>)" title="商品采集"><i class="Hui-iconfont">&#xe641;</i></a>
...
<script type="text/javascript">
    ...
    function collect_product(type,id) {
        ...
        switch (type) {
            ...
            case 1:
                title = '采集商品';
                url = '<?php echo url("quan/show"); ?>'+'?type=1&id='+id;
                break;
            case 2:
                title = '一键采集';
                url = '<?php echo url("quan/show"); ?>'+'?type=2';
                break;
            ...
            layui.use(['layer'], function(){
                ...
                if(ids.length ===0){
                    ...
                    layer.confirm('确认要删除吗？',function(index){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '<?php echo url("quan/deleteAll"); ?>',
                            dataType: 'json',
                            data: {ids:ids},
                            success: function(res){
                                if(res.status ==='ok'){
...
<script type="text/javascript">
    ...
    layui.use(['laypage'], function(){
        ...
        skin: '#5FB878', //自定义选中色值
            ...
            if(!first){
                window.location = "<?php echo url('quan/index'); ?>?page="+ obj.curr;
            }
        }
    });
    });
