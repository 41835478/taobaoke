<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp\www\taobaoke\public/../application/admin\view\ad\index.html";i:1497361275;s:63:"D:\wamp\www\taobaoke\public/../application/admin\view\base.html";i:1497357983;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort layui-form">
            ...
            <tr class="text-c">
                ...
                <td><img width="210" class="picture-thumb" src="/uploads/<?php echo $vo['image_url']; ?>"></td>
