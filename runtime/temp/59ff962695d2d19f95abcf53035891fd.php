<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp\www\taobaoke\public/../application/admin\view\collect\index.html";i:1497683771;s:63:"D:\wamp\www\taobaoke\public/../application/admin\view\base.html";i:1497357983;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<script type="text/javascript">
    var add_url ='<?php echo url("collect/add"); ?>';
</script>
    ...
    <div class="mt-20">
        ...
        <table class="layui-table layui-form">
            ...
            <tr>
                ...
                <td data-favorites-id="<?php echo $vo['favorites_id']; ?>"><?php echo $vo['favorites_name']; ?></td>
                <td><?php switch($vo['type']): case "1": ?>高佣金<?php break; default: ?>普通<?php endswitch; ?></td>
...
<script type="text/javascript">
    ...
    function collect_product(type,id) {
        ...
        switch (type) {
            ...
            case 1:
                title = '采集商品';
                url = '<?php echo url("collect/show"); ?>'+'?type=1&id='+id;
                break;
            case 2:
                title = '一键采集';
                url = '<?php echo url("collect/show"); ?>'+'?type=2';
                break;
        ...
        $('.collect-delete').on('click',function (e) {
            ...
            layui.use(['layer'], function(){
                ...
                layer.confirm('确认要删除吗？',function(index){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo url("collect/delete"); ?>',
                        dataType: 'json',
                        data: {id:id},
            ...
            layui.use(['layer'], function(){
                ...
                if(ids.length ===0){
                    ...
                    layer.confirm('确认要删除吗？',function(index){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '<?php echo url("collect/deleteAll"); ?>',
                            dataType: 'json',
                            data: {ids:ids},
                            success: function(res){
                                if(res.status ==='ok'){
...
<script type="text/javascript">
    ...
    layui.use(['laypage'], function(){
        ...
        skin: '#5FB878', //自定义选中色值
            ...
            if(!first){
                window.location = "<?php echo url('collect/index'); ?>?page="+ obj.curr;
            }
        }
    });
    });
