<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\wamp\www\taobaoke/application/home\view\quan\index.html";i:1500413702;s:52:"D:\wamp\www\taobaoke/application/home\view\base.html";i:1500414802;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="choose-container">
    <div class="choose-list product-category">
        ...
        <div class="list">
            <a class="<?php if(isset($urlInfo['cid']) && !is_numeric($urlInfo['cid'])): if(in_array(($urlInfo['cid']), explode(',',"all"))): ?>active<?php endif; endif; ?>" href="<?php echo url('quan/index'); ?>">全部优惠<span>（<?php echo $baseData['cate']['totalNum']; ?>）</span></a>
            <?php if(!empty($baseData['cate']['cateInfo'])): foreach($baseData['cate']['cateInfo'] as $cate): ?>
            <a class="<?php if(isset($urlInfo['cid']) && is_numeric($urlInfo['cid']) && ($urlInfo['cid'] == $cate['id'])): ?>active<?php endif; ?>" href="<?php echo url('quan/index',['cid'=>$cate['id']]); ?>"><?php echo $cate['cate_name']; ?><span>（<?php echo $cate['total']; ?>）</span></a>
            <?php endforeach; else: endif; ?>
    ...
    <div class="choose-list onsale-type">
        ...
        <div class="list">
            <div class="checkbox-list">
                <a class="<?php if(isset($urlInfo['type']) && $urlInfo['type'] ==1): ?>active<?php endif; ?>" href="<?php echo url('quan/index',['cid'=>$urlInfo['cid'],'type'=>1]); ?>" target="_self">
                    <i class="iconfont icon-checkbox"></i>
                    天猫
                </a>
            </div>
<!--            <div class="checkbox-list">
                <input type="checkbox" id="tmall" name="tmall" value="1" />
                <label for="tmall">
                    <i class="iconfont icon-checkbox"></i>
                    天猫
                </label>
            ...
            <div class="checkbox-list">
                <a class="<?php if(isset($urlInfo['aid']) && $urlInfo['aid'] == $activity['id']): ?>active<?php endif; ?>" href="<?php echo url('quan/index',['cid'=>$urlInfo['cid'],'aid'=>$activity['id']]); ?>" target="_self">
                    <i class="iconfont icon-checkbox"></i>
            ...
            <div class="checkbox-list confirm">
                ...
                <a href="<?php echo url('quan/index',['cid'=>$urlInfo['cid']]); ?>" class="btn btn-reset" name="button">重置</a>
            </div>
...
<div class="product-sort-container">
    <ul class="product-sort-list">
        <li class="sort-list <?php if($urlInfo['sort'] == 'multiple'): ?>active<?php endif; ?>" >
            <a href="<?php echo url('quan/index',array_merge($urlInfo,['sort'=>'multiple'])); ?>" data-sort="1">综合</a>
        </li>
        <li class="sort-list <?php if($urlInfo['sort'] == 'latest'): ?>active<?php endif; ?>">
            <a href="<?php echo url('quan/index',array_merge($urlInfo,['sort'=>'latest'])); ?>" data-sort="2">最新</a>
        </li>
        <li class="sort-list <?php if($urlInfo['sort'] == 'volume'): ?>active<?php endif; ?>" >
            <a href="<?php echo url('quan/index',array_merge($urlInfo,['sort'=>'volume'])); ?>" data-sort="3">销量</a>
        </li>
        <li class="sort-list <?php if($urlInfo['sort'] == 'quan'): ?>active<?php endif; ?>">
            <a href="<?php echo url('quan/index',array_merge($urlInfo,['sort'=>'quan'])); ?>" data-sort="4">领券量</a>
        </li>
        <li class="sort-list <?php if($urlInfo['sort'] == 'price'): ?>active<?php endif; ?>" >
            <a href="<?php echo url('quan/index',array_merge($urlInfo,['sort'=>'price'])); ?>" data-sort="5">价格</a>
        </li>
    </ul>
    <ul class="page-items">
        <li class="item">
            <a class="link-left" href="<?php echo url('quan/index',array_merge($urlInfo,['page'=>$pageInfo['cur']-1])); ?>">
        ...
        <li class="item">
            <a class="link-right" href="<?php echo url('quan/index',array_merge($urlInfo,['page'=>$pageInfo['cur']+1])); ?>">
        ...
        laypage({
            ...
            jump:function (obj, first) {
                if (!first) {
                    ...
                    location.href= '<?php echo url("quan/index",$urlInfo); ?>'+'?page='+obj.curr;
                }
