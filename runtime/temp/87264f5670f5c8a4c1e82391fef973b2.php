<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\wamp\www\taobaoke\public/../application/admin\view\activity\index.html";i:1499861368;s:63:"D:\wamp\www\taobaoke\public/../application/admin\view\base.html";i:1497357983;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<script type="text/javascript">
    var add_url ='<?php echo url("activity/add"); ?>';
    var update_url ='<?php echo url("activity/update"); ?>';
    var activity_status = '<?php echo url("activity/activityShow"); ?>';
</script>
...
<div class="page-container">
    ...
    <div class="mt-20">
        ...
        <table class="layui-table layui-form">
            ...
            <tbody>
            <?php if(!empty($activityList)): foreach($activityList as $vo): ?>
            <tr>
                ...
                <td>
                    <div class="layui-input-block" style="margin-left: 0">
                        <input type="checkbox" name="switch"  value="<?php echo $vo['is_qiang']; ?>" <?php if($vo['is_qiang'] == '1'): ?>checked<?php endif; ?> lay-skin="switch" lay-text="ON|OFF" lay-filter="switch" disabled/>
                    </div>
                </td>
        ...
        $('.ad-delete').on('click',function (e) {
            ...
            layui.use(['layer'], function(){
                ...
                layer.confirm('确认要删除吗？',function(index){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo url("activity/delete"); ?>',
                        dataType: 'json',
                        data: {id:id},
                        success: function(res){
                            if(res.status ==='ok'){
            ...
            layui.use(['layer'], function(){
                ...
                if(ids.length ===0){
                    ...
                    layer.confirm('确认要删除吗？',function(index){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '<?php echo url("activity/deleteAll"); ?>',
                            dataType: 'json',
                            data: {ids:ids},
                            success: function(res){
                                if(res.status ==='ok'){
    ...
    layui.use(['laypage'], function(){
        ...
        laypage({
            ...
            jump: function(obj, first){
                if(!first){
                    window.location = "<?php echo url('activity/index'); ?>?page="+ obj.curr;
                }
            }
        });
    });
